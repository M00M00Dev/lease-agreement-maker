...
const App = () => {
  const [formData, setFormData] = useState({
    ...
    bondAmount: '496.00',
    bondDue: '',
    isBondLodged: true, // Added back the state for RTBA
    periodMonths: '3',
    startDate: '',
    endDate: '',
        ...
        <div className="lg:col-span-5 space-y-6 print:hidden">
          ...
          <section className="bg-white p-6 rounded-xl shadow-sm border border-gray-200">
            ...
            <div className="space-y-4">
              ...
              {/* Added back the RTBA Checkbox */}
              <div className="flex items-center gap-2 p-2 bg-slate-50 border rounded-lg mt-2">
        ...
        <div className="lg:col-span-7 bg-white p-8 md:p-12 shadow-2xl rounded-sm border border-gray-200 print:shadow-none print:border-none print:m-0 print:p-0">
          ...
          <div className="text-[11pt] leading-relaxed space-y-4 text-gray-900">
            ...
            <div className="mt-6">
              ...
              {/* Added back the conditional RTBA clause */}
              {formData.isBondLodged && (
